...
namespace Wodsoft.StunServer
{
    public class StunService
    {
        ...
        private bool CreateUDP(IPAddress primaryAddress, IPAddress secondaryAddress, int primaryPort, int secondaryPort,
            IPAddress localPrimaryAddress, IPAddress localSecondaryAddress, int localPrimaryPort, int localSecondaryPort,
            List<Task> tasks, ILogger logger, CancellationToken cancellationToken)
        {
            ...
            tasks.Add(ListenUDP(a1p1Socket, a1p2Socket, a2p1Socket, a2p2Socket, primaryAddress, primaryPort, secondaryAddress, secondaryPort, logger, cancellationToken));
            tasks.Add(ListenUDP(a1p2Socket, a1p1Socket, a2p2Socket, a2p1Socket, primaryAddress, secondaryPort, secondaryAddress, primaryPort, logger, cancellationToken));
            tasks.Add(ListenUDP(a2p1Socket, a2p2Socket, a1p1Socket, a1p2Socket, secondaryAddress, primaryPort, primaryAddress, secondaryPort, logger, cancellationToken));
            tasks.Add(ListenUDP(a2p2Socket, a2p1Socket, a1p2Socket, a1p1Socket, secondaryAddress, secondaryPort, primaryAddress, primaryPort, logger, cancellationToken));
        ...
        private bool CreateTCP(IPAddress primaryAddress, IPAddress secondaryAddress, int primaryPort, int secondaryPort,
            IPAddress localPrimaryAddress, IPAddress localSecondaryAddress, int localPrimaryPort, int localSecondaryPort,
            List<Task> tasks, ILogger logger, CancellationToken cancellationToken)
        {
            ...
            tasks.Add(ListenTCP(a1p1Socket, a1p2Socket, a2p1Socket, a2p2Socket, primaryAddress, primaryPort, secondaryAddress, secondaryPort, logger, cancellationToken));
            tasks.Add(ListenTCP(a1p2Socket, a1p1Socket, a2p2Socket, a2p1Socket, primaryAddress, secondaryPort, secondaryAddress, primaryPort, logger, cancellationToken));
            tasks.Add(ListenTCP(a2p1Socket, a2p2Socket, a1p1Socket, a1p2Socket, secondaryAddress, primaryPort, primaryAddress, secondaryPort, logger, cancellationToken));
            tasks.Add(ListenTCP(a2p2Socket, a2p1Socket, a1p2Socket, a1p1Socket, secondaryAddress, secondaryPort, primaryAddress, primaryPort, logger, cancellationToken));
        ...
        private bool CreateTLS(IPAddress primaryAddress, IPAddress secondaryAddress, int primaryPort, int secondaryPort,
            IPAddress localPrimaryAddress, IPAddress localSecondaryAddress, int localPrimaryPort, int localSecondaryPort,
            List<Task> tasks, X509Certificate2 certificate, ILogger logger, CancellationToken cancellationToken)
        {
            ...
            tasks.Add(ListenTLS(a1p1Socket, a1p2Socket, a2p1Socket, a2p2Socket, primaryAddress, primaryPort, secondaryAddress, secondaryPort, certificate, logger, cancellationToken));
            tasks.Add(ListenTLS(a1p2Socket, a1p1Socket, a2p2Socket, a2p1Socket, primaryAddress, secondaryPort, secondaryAddress, primaryPort, certificate, logger, cancellationToken));
            tasks.Add(ListenTLS(a2p1Socket, a2p2Socket, a1p1Socket, a1p2Socket, secondaryAddress, primaryPort, primaryAddress, secondaryPort, certificate, logger, cancellationToken));
            tasks.Add(ListenTLS(a2p2Socket, a2p1Socket, a1p2Socket, a1p1Socket, secondaryAddress, secondaryPort, primaryAddress, primaryPort, certificate, logger, cancellationToken));
